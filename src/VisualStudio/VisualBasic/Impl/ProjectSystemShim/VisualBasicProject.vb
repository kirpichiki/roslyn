...
Namespace Microsoft.VisualStudio.LanguageServices.VisualBasic.ProjectSystemShim
    Partial Friend NotInheritable Class VisualBasicProject
        ...
        Private _runtimeLibraries As ImmutableArray(Of String) = ImmutableArray.Create(Of String)
        ...
        Friend Sub New(projectSystemName As String,
            ...
            ProjectCodeModel = New ProjectCodeModel(threadingContext, VisualStudioProject.Id, New VisualBasicCodeModelInstanceFactory(Me), Workspace, serviceProvider)

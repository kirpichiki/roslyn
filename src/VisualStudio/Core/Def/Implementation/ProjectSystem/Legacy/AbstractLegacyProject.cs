...
namespace Microsoft.VisualStudio.LanguageServices.Implementation.ProjectSystem.Legacy
{
    ...
    internal abstract partial class AbstractLegacyProject : ForegroundThreadAffinitizedObject
    {
            ...
            SourceCodeKind sourceCodeKind)
        {
            ...
            // Remove this hack once https://devdiv.visualstudio.com/DevDiv/_git/VS/pullrequest/138155 is merged
            if (filename.EndsWith(".aspx", StringComparison.OrdinalIgnoreCase) ||
                ...
                filename.EndsWith(".vbhtml", StringComparison.OrdinalIgnoreCase) ||
                filename.EndsWith(".xoml", StringComparison.OrdinalIgnoreCase))
            {

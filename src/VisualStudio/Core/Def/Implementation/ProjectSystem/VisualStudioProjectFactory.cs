...
namespace Microsoft.VisualStudio.LanguageServices.Implementation.ProjectSystem
{
    ...
    internal sealed class VisualStudioProjectFactory
    {
        ...
        public VisualStudioProjectFactory(VisualStudioWorkspaceImpl visualStudioWorkspaceImpl)
        {
        ...
        public VisualStudioProject CreateAndAddToWorkspace(string projectUniqueName, string language, VisualStudioProjectCreationInfo creationInfo)
        {
            ...
            var project = new VisualStudioProject(_visualStudioWorkspaceImpl, id, projectUniqueName, language, directoryNameOpt);

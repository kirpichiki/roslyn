...
namespace Microsoft.VisualStudio.LanguageServices.Implementation.ProjectSystem
{
    internal sealed class VisualStudioProject
    {
        ...
        private readonly FileChangeWatcher.IContext _fileChangeContext;

        private readonly DocumentCollection _sourceFiles;
        private readonly DocumentCollection _additionalFiles;

        internal VisualStudioProject(VisualStudioWorkspaceImpl workspace, ProjectId id, string projectUniqueName, string language, string directoryNameOpt)
        {
            ...
            {
                _fileChangeContext = _workspace.FileChangeWatcher.CreateContextForDirectory(directoryNameOpt);
            }
            else
            {
                _fileChangeContext = workspace.FileChangeWatcher.CreateContext();
            }
            ...
            lock (_gate)
            {
                ...
                _workspace.ApplyBatchChangeToProject(Id, solution =>
                {
                    ...
                    if (_metadataReferencesAddedInBatch.Count > 0)
                    {
                        ...
                        _metadataReferencesAddedInBatch.Clear();
                        _metadataReferencesAddedInBatch.Capacity = 0;
                    }
                    ...
                    _metadataReferencesRemovedInBatch.Clear();
                    _metadataReferencesRemovedInBatch.Capacity = 0;

                    // Project reference adding...
                    solution = solution.AddProjectReferences(Id, _projectReferencesAddedInBatch);
                    _projectReferencesAddedInBatch.Clear();
                    _projectReferencesAddedInBatch.Capacity = 0;
                    ...
                    _projectReferencesRemovedInBatch.Clear();
                    _projectReferencesRemovedInBatch.Capacity = 0;
                    ...
                    _projectPropertyModificationsInBatch.Clear();
                    _projectPropertyModificationsInBatch.Capacity = 0;
        ...
        /// </summary>
        /// <remarks>This class should be free-threaded, and any synchronization is done via <see cref="VisualStudioProject._gate"/>.</remarks>
        private class DocumentCollection
        {
            ...
            public DocumentId AddFile(string fullPath, SourceCodeKind sourceCodeKind, ImmutableArray<string> folders)
            {
                ...
                lock (_project._gate)
                {
                    ...
                    _project._fileWatchingTokens.Add(documentId, _project._fileChangeContext.EnqueueWatchingFile(fullPath));
            ...
            public void RemoveFile(string fullPath)
            {
                ...
                lock (_project._gate)
                {
                    ...
                    _project._fileChangeContext.StopWatchingFile(_project._fileWatchingTokens[documentId]);
                ...
                Func<Solution, DocumentId, Solution> removeDocument)
            {
                ...
                _documentsAddedInBatch.Clear();
                _documentsAddedInBatch.Capacity = 0;
                ...
                _documentsRemovedInBatch.Clear();
                _documentsRemovedInBatch.Capacity = 0;
